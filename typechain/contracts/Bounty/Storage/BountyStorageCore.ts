...
export interface BountyStorageCoreInterface extends utils.Interface {
  functions: {
...
export interface BountyStorageCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BountyStorageCoreInterface;
