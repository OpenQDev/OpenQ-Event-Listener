...
export interface TieredBountyStorageCoreInterface extends utils.Interface {
  functions: {
...
export interface TieredBountyStorageCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TieredBountyStorageCoreInterface;
