...
export interface AtomicBountyStorageV1Interface extends utils.Interface {
  functions: {
    ...
    "invoiceComplete()": FunctionFragment;
    ...
    "supportingDocumentsComplete()": FunctionFragment;
...
export interface AtomicBountyStorageV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AtomicBountyStorageV1Interface;
  ...
  functions: {
    ...
    invoiceComplete(overrides?: CallOverrides): Promise<[boolean]>;
    ...
    supportingDocumentsComplete(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    invoiceComplete(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    supportingDocumentsComplete(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    invoiceComplete(overrides?: CallOverrides): Promise<PopulatedTransaction>;
