...
export interface TieredFixedBountyV1Interface extends utils.Interface {
  functions: {
...
export interface TieredFixedBountyV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TieredFixedBountyV1Interface;
