...
export interface TieredPercentageBountyV1Interface extends utils.Interface {
  functions: {
...
export interface TieredPercentageBountyV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TieredPercentageBountyV1Interface;
