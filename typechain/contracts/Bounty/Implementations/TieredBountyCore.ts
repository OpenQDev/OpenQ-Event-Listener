...
export interface TieredBountyCoreInterface extends utils.Interface {
  functions: {
...
export interface TieredBountyCore extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TieredBountyCoreInterface;
