...
export interface ClaimManagerV1Interface extends utils.Interface {
  functions: {
    "VERSION_1()": FunctionFragment;
    "claimBounty(address,address,bytes)": FunctionFragment;
    "hasKYC(address)": FunctionFragment;
    ...
    "permissionedClaimTieredBounty(address,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "permissionedClaimTieredBounty",
...
export interface ClaimManagerV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClaimManagerV1Interface;
