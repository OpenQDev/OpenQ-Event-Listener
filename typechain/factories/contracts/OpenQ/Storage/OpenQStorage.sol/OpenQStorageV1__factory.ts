...
import type {
  OpenQStorageV1,
  OpenQStorageV1Interface,
} from "../../../../../contracts/OpenQ/Storage/OpenQStorage.sol/OpenQStorageV1";
...
export class OpenQStorageV1__factory {
  static readonly abi = _abi;
  static createInterface(): OpenQStorageV1Interface {
    return new utils.Interface(_abi) as OpenQStorageV1Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OpenQStorageV1 {
    return new Contract(address, _abi, signerOrProvider) as OpenQStorageV1;
  }
}
